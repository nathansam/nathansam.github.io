...
{% include figure.html path="assets/img/coding.jpg" class="img-fluid rounded z-depth-1" zoomable=true%}
...
<div class = "twitter">
{% twitter https://twitter.com/neil_ferguson/status/1241835454707699713 %}
</div>
